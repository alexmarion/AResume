var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		*/
		this.profilePic = new AR.Model("assets/profilePic.wt3", {
			onLoaded: this.loadingStep,
			/*
		...
		*/
		this.appearingAnimation = this.createAppearingAnimation(this.profilePic, 0.045);

		/*
			The rotation animation for the 3D model is created by defining an AR.PropertyAnimation for the rotate.roll property.
		*/
		this.rotationAnimation = new AR.PropertyAnimation(this.profilePic, "rotate.roll", -25, 335, 10000);
        //this.rotationAnimation = new AR.PropertyAnimation(this.profilePic, );
		...
		*/
		var trackable = new AR.Trackable2DObject(this.tracker, "*", {
			drawables: {
				cam: [this.profilePic, buttonRotate]
			},
	...
	loadingStep: function loadingStepFn() {
		if (!World.loaded && World.tracker.isLoaded() && World.profilePic.isLoaded()) {
			World.loaded = true;
	...
	resetModel: function resetModelFn() {
		...
		World.profilePic.rotate.roll = -25;
	},
