...
FaceDetectionPlugin::FaceDetectionPlugin(const std::string& pluginIdentifier, int cameraFrameWidth_, int cameraFrameHeight_, std::string databasePath_, FaceDetectionPluginObserver& observer_ ) :
...
void FaceDetectionPlugin::cameraFrameAvailable(const wikitude::sdk::Frame& cameraFrame_) {
    ...
    if (currentInterfaceOrientation == wikitude::sdk::InterfaceOrientation::InterfaceOrientationPortrait) {
        cv::transpose(smallImg, smallImg);
        cv::flip(smallImg, smallImg, 1);
    }
    else if (currentInterfaceOrientation == wikitude::sdk::InterfaceOrientation::InterfaceOrientationPortraitUpsideDown) {
        cv::transpose(smallImg, smallImg);
        cv::flip(smallImg, smallImg, 0);
    }
    else if (currentInterfaceOrientation == wikitude::sdk::InterfaceOrientation::InterfaceOrientationLandscapeLeft) {
        cv::flip(smallImg, smallImg, -1);
    }
    else if (currentInterfaceOrientation == wikitude::sdk::InterfaceOrientation::InterfaceOrientationLandscapeRight) {
...
void FaceDetectionPlugin::convertFaceRectToModelViewMatrix(cv::Mat& frame_, cv::Rect& faceRect_, wikitude::sdk::InterfaceOrientation interfaceOrientation_) {
    ...
    if (interfaceOrientation_ == wikitude::sdk::InterfaceOrientation::InterfaceOrientationPortrait || interfaceOrientation_ == wikitude::sdk::InterfaceOrientation::InterfaceOrientationPortraitUpsideDown) {
