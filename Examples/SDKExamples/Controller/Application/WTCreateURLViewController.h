...
@property (nonatomic, weak) IBOutlet UISwitch               *requiredFeature2dtrackingSwitch;
@property (weak, nonatomic) IBOutlet UISwitch               *requiredFeatureGeoSwitch;
@property (weak, nonatomic) IBOutlet UISwitch               *captureDevicePositionSwitch;
