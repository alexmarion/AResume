...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    {
        [self.augmentedRealityExperiencesManager loadAugmentedRealityExperiencesFromPlist:^(NSUInteger numberOfExperienceCategories)
        {
             [self.tableView insertSections:[NSIndexSet indexSetWithIndexesInRange:NSMakeRange(0, numberOfExperienceCategories)] withRowAnimation:UITableViewRowAnimationFade];
        }];
    }
}
